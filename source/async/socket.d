...
import async.internals.socket_compat;
import async.internals.freelist;
import async.internals.queue;

public import std.socket : SocketType, SocketOSException;
public import async.internals.socket_compat :
	SOCK_STREAM, SOCK_SEQPACKET, SOCK_DGRAM, SOCK_RAW, SOCK_RDM,
	AF_INET, AF_INET6,
	SOL_SOCKET,
	SO_REUSEADDR;
version (Posix) public import async.internals.socket_compat :
	AF_UNIX,
	SO_REUSEPORT;
...
version (Posix) {
	...
	import async.internals.win32 : WSABUF, DWORD;
...
public:
	...
	{
		import async.internals.socket_compat : getsockname;
	...
	{
		import async.internals.socket_compat : getpeername;
	...
	{
		import async.internals.socket_compat : getsockopt;
	...
	{
		import async.internals.socket_compat : setsockopt;
...
package:
	...
	{
		import async.internals.socket_compat : SOL_SOCKET, SO_ERROR;
		int code;
...
struct NetworkAddress
{
	...
	version (Posix) import async.internals.socket_compat :
		sockaddr_un, AF_UNIX;
...
{
	import async.internals.socket_compat : getsockopt, SOL_SOCKET, SO_TYPE;
